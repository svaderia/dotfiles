...
export ZSH="/Users/svaderia/.oh-my-zsh"
...
if [ $? -eq 0 ]; then
    ...
    if [ -f "/Users/svaderia/opt/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/Users/svaderia/opt/anaconda3/etc/profile.d/conda.sh"
    else
        export PATH="/Users/svaderia/opt/anaconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
